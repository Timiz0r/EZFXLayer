namespace EZUtils.EZFXLayer
{
    ...
    [LocalizationProxy] //keep in sync with localization assembly. is here so that uxml files in this assembly get localized
    [GenerateLanguage("en", "Localization/template.pot")] //we dont generate plural rules because crowdin will then try to overwrite others'
    [GenerateLanguage("ja", "Localization/ja.po", Other = " @integer 0~15, 100, 1000, 10000, 100000, 1000000, … @decimal 0.0~1.5, 10.0, 100.0, 1000.0, 10000.0, 100000.0, 1000000.0, …")]
    public static class UxmlLocalizationHelper
    {
